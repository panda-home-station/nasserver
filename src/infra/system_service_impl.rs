...
use crate::models::system::{SystemStats, StatsHistoryQuery, DeviceInfoResp, HardwareInfo, NetworkInfo, DiskUsage, PhysicalDisk, InitReq, PortStatus};
...
impl SystemService for SystemServiceImpl {
    ...
    async fn get_gpus(&self) -> Vec<crate::handlers::gpu::GpuInfo> {
        crate::handlers::gpu::get_system_gpus()
    }
