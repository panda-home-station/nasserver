...
use crate::models::system::{InitReq, DeviceInfoResp, PortCheckReq, PortCheckResp, SystemStats, StatsHistoryQuery, InitStateResp};
...
pub async fn version() -> Json<crate::models::system::VersionResp> {
    Json(crate::models::system::VersionResp {
