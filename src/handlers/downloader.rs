...
use crate::models::downloader::{CreateDownloadReq, ControlDownloadReq, ResolveMagnetReq, StartMagnetDownloadReq, ResolveMagnetResp};
use crate::models::auth::AuthUser;
use crate::core::Result;

pub async fn list_downloads(State(state): State<AppState>) -> Result<Json<Vec<crate::services::downloader_service::DownloadTaskResp>>> {
...
pub async fn control_download(
    ...
    match payload.action.as_str() {
        ...
        _ => return Err(crate::core::AppError::BadRequest("Invalid action".to_string())),
    }
    Ok(StatusCode::OK)
}
